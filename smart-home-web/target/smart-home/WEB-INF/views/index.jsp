        ...
        <div class="row feature_wrapper">
            ...
            <div class="features_op1_row">
                ...
                <div class="col-sm-4 feature first">
                    <div class="img_box">
                        <a href="services.html">
                            <img src="<c:url value='/resources/img/canvas/service1.png'/>">
                                <span class="circle">
                ...
                <div class="col-sm-4 feature">
                    <div class="img_box">
                        <a href="services.html">
                            <img src="<c:url value='/resources/img/canvas/service2.png'/>">
                                <span class="circle">
                                    <span class="plus">&#43;</span>
                                </span>
                        </a>
                ...
                <div class="col-sm-4 feature last">
                    <div class="img_box">
                        <a href="services.html">
                            <img src="<c:url value='/resources/img/canvas/service3.png'/>">
                                <span class="circle">
                                    <span class="plus">&#43;</span>
                                </span>
                        </a>
...
<div id="features">
    <div class="container">
        ...
        <div class="row feature">
            <div class="col-sm-6">
                <img src="<c:url value='/resources/img/canvas/showcase1.png'/>" class="img-responsive" />
            </div>
            <div class="col-sm-6 info">
                <h3>
                    <img src="<c:url value='/resources/img/canvas/features-ico1.png'/>" />
        ...
        <div class="row feature">
            <div class="col-sm-6 pic-right">
                <img src="<c:url value='/resources/img/canvas/showcase2.png'/>" class="pull-right img-responsive" />
            </div>
            <div class="col-sm-6 info info-left">
                <h3>
                    <img src="<c:url value='/resources/img/canvas/features-ico2.png'/>" />
                    Blog page included
                </h3>
                <p>
                    There are many variations of passages of Lorem Ipsum available, but the randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.
        ...
        <div class="row feature">
            <div class="col-sm-6">
                <img src="<c:url value='/resources/img/canvas/showcase3.png'/>" class="img-responsive" />
            </div>
            <div class="col-sm-6 info">
                <h3>
                    <img src="<c:url value='/resources/img/canvas/features-ico3.png'/>" />
    ...
    <div class="container">
        ...
        <div class="row charts_wrapp">
            ...
            <div class="col-sm-4 pro">
                <div class="plan">
                    <div class="wrapper">
                        <img class="ribbon" src="<c:url value='/resources/img/canvas/badge.png'/>">
                        <h3>Pro</h3>
                        <div class="price">
                            <span class="dollar">$</span>
